...
public class AreaUpdateImpl implements AreaUpdateService {
    final AreaUpdateRepository areaUpdateRepository;
    final AreaCachePool areaCachePool;

    public AreaUpdateImpl(AreaUpdateRepository areaUpdateRepository, AreaCachePool areaCachePool) {
        this.areaUpdateRepository = areaUpdateRepository;
