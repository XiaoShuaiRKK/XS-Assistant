...
//  TestApp
//
//  Created by Already on 2023/12/4.
//
...
struct SignUpView: View {
    ...
    var body: some View {
        VStack(alignment: .leading,spacing: 16) {
            ...
            Text("Join us now and experience your life assistant")
                .font(.headline)
            ...
            Group {
                ...
                +
                Text(",you agree to our **Terms of Service** and **[Privacy Policy](https://www.apple.com)**")
                Divider()
                HStack {
